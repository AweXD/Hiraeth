...
client.on("ready", ()  =>{
  ...
  function mytimer(args){
    ...
    if (pst.getDay() == 1) {
      ...
      if (pst.getHours() == 20){
        if (pst.getMinutes() == 00) client.guilds.get("420258815112642561").channels.get("532793169461510145").send(spawn["Monday"]["20:15"] + " will spawn in 15mins!");
      ...
      if (pst.getHours() == 22){
        if (pst.getMinutes() == 00) client.guilds.get("420258815112642561").channels.get("532793169461510145").send(spawn["Monday"]["22:15"] + " will spawn in 15mins!");
    ...
    if(pst.getDay() == 2){
      ...
      if (pst.getHours() == 20){
        if (pst.getMinutes() == 00) client.guilds.get("420258815112642561").channels.get("532793169461510145").send(spawn["Tuesday"]["20:15"] + " will spawn in 15mins!");
      ...
      if (pst.getHours() == 22){
        if (pst.getMinutes() == 00) client.guilds.get("420258815112642561").channels.get("532793169461510145").send(spawn["Tuesday"]["22:15"] + " will spawn in 15mins!");
